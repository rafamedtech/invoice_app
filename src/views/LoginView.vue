  ...
  <main class="bg-[#f2f2f2]">
    ...
    >
      ...
      <form
        ...
        class="mt-10 shadow-lg flex w-full flex-col rounded-[20px] bg-white bg-opacity-50 p-8 md:mt-0 md:w-1/2 lg:w-2/6"
      >
        <h2
        ...
        <div class="relative mb-4">
          ...
          <div class="relative">
            <input
              ...
              id="email"
              name="email"
              class="w-full rounded border border-gray-600 bg-transparent bg-opacity-20 py-1 px-3 text-base leading-8 text-[#1a1a1a] outline-none transition-colors duration-200 ease-in-out focus:border-secondary focus:bg-transparent focus:ring-2 focus:ring-transparent"
              :class="{
